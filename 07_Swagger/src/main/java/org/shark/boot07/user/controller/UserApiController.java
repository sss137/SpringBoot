...
import org.shark.boot07.user.dto.request.UserCreatedRequestDTO;
...
public class UserApiController {
  ...
  public ResponseEntity<ApiUserResponseDTO> create(@Valid @RequestBody UserCreatedRequestDTO user) {
    ApiUserResponseDTO createUser = ApiUserResponseDTO.builder()
  ...
  @Operation(summary = "사용자 정보 수정",
             description = "비밀번호, 닉네임을 수정하는 신규 사용자 정보 등록 API")
  @ApiResponses(value = {
  ...
  @Operation(summary = "사용자 정보 삭제",
             description = "사용자 번호가 일치하는 사용자를 삭제하는 API")
  @ApiResponses(value = {
  @ApiResponse(responseCode = "200",
  ...
  @Operation(summary = "사용자 정보 조회",
             description = "사용자 번호가 일치하는 사용자를 조회하는 API")
  @ApiResponses(value = {
  @ApiResponse(responseCode = "200",
  ...
  @Operation(summary = "사용자 목록 조회",
             description = "요청 파라미터(page, size, sort)에 따른 목록을 조회하는 API")
  @ApiResponses(value = {
  @ApiResponse(responseCode = "200",
  ...
  @Parameters(value = {
      ...
      @Parameter(name = "size",
                 required = false,
                 description = "한 페이지의 포함할 사용자 수",
                 in = ParameterIn.QUERY),
      @Parameter(name = "sort",
                 required = false,
                 description = "사용자 정령 방식",
                 in = ParameterIn.QUERY,
                 schema = @Schema(implementation = SortType.class))
               
  })
  public ResponseEntity<ApiUserResponseDTO> list(PageDTO pageDTO,
